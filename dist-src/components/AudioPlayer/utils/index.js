import { PauseCircleFilled as PauseIcon, PlayCircleFilled as PlayIcon } from '@material-ui/icons';
...
export const getProgress = (currentTime, duration) => parseFloat(100 * (currentTime / duration));
export const getCurrentTime = (progress, duration) => parseFloat(progress * duration / 100);